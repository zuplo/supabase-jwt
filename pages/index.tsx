...
export default function Home() {
  ...
  return (
    <div className="m-10 max-w-lg flex flex-col space-y-6">
      <h1 className="text-5xl font-bold">Supabase Auth Helper</h1>
      <h2 className="text-xl text-pink-500">
        <em>&ldquo;because sometimes you just want a JWT token</em>&rdquo;
      </h2>
      <div className="text-sm border rounded p-3 bg-gray-200 flex flex-row items-start">
        <ExclamationTriangleIcon className="w-4 h-auto flex-none mt-0.5 mr-1 text-pink-500" />
        This is a fully client-side application designed to help you quickly get
        a JWT token for supabase. No data is sent to our servers and your
      ...
      {!session && (
        <>
          <div>
            <div className="font-bold">
              ...
              <span className="text-xs text-gray-400 font-light">
                get from API Docs &gt; Introduction
              </span>
            </div>
            <input
              type="text"
          ...
          <div>
            <div className="font-bold">
              Anon Key - <span className="text-red-500 underline">not</span>{" "}
              service_role{" "}
              <span className="text-xs text-gray-400 font-light">
